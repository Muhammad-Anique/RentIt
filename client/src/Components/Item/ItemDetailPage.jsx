  ...
  return (
    <div className='w-full h-auto flex items-center justify-center'>
        <div className='w-[70%]  h-auto py-2 px-2 font-medium mt-4'>
           <h1 className='text-xl font-bold'>The Used Clothes</h1>
           <div className='flex flex-row justify-center items-center h-[400px] mt-4'>
            <div className='w-[50%] h-full rounded-l-lg overflow-hidden '>
                <img className='object-cover' src="https://www.thoughtco.com/thmb/DxSLkmDcJK6rvht3DLI8LLcKv4s=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/close-up-of-clothes-hanging-in-row-739240657-5a78b11f8e1b6e003715c0ec.jpg" alt="" />
            </div>
           ...
           <div className=' w-full h-auto flex flex-row justify-between gap-10 mt-5'>
                <div className='flex flex-col mt-3 w-[50%]'>
                    <h1>The Used Clothes From Super Market</h1>
                    <p className='text-xs text-[#4b4b4b]'>#Sports #Clothes #Cheap</p>
                 ...
                 <div className='flex flex-row  items-center mt-5 '>
                    ...
                    <div className='ml-5 '>
                        <h1 className='text-xs'>Hamza Khaan</h1>
                        <p className='text-[9px] text-[#4b4b4b]'>10-2-2023</p>
                    </div>
                 </div>
              
                 <hr className='w-[100%] bg-[#c2c2c2] h-[1px] mt-5'/>
                 <p className='text-xs text-[#6c6c6c] mt-3'>
                    Clothes are garments or items worn on the body. They serve various purposes such as protection from the elements, modesty, and fashion. Clothes can be made from different materials like cotton, silk, wool, polyester, or blends of these materials. They come in various styles, sizes, and designs, reflecting cultural, social, and individual preferences. Clothes can range from everyday wear like shirts, pants, dresses, and shoes to specialized clothing for different activities like sports, formal events, or work uniforms.</p>
                 <hr className='w-[100%] bg-[#c2c2c2] h-[1px] mt-5'/>
                </div>
